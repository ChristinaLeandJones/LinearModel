...
model1 appears to be slightly better model because it has a lower Residual standard error score then model1 and also has a higher adjusted R sqaure score than model2 as well. 
